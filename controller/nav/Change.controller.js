sap.ui.define([
    ...
    "sap/m/MessageToast",
        ...
        return Controller.extend("sap.hum.pfe.controller.nav.Change", {
            ...
            ChangeHU: function() {
                ...
                if (handlingUnitNumber) {
                    var packagingMaterial = Math.floor(Math.random() * 9000) + 100;
            ...
            saveAction: function() {
                ...
                if (hucInput && packMatInput) { // Check if inputs are not empty
                    var handlingUnitNumber = this.getView().byId("huInput").getValue();
                    MessageToast.show("Handling units number " + handlingUnitNumber + " were updated.", {
            ...
            cancelAction : function () {
                if (!this.pDialog2) {
                    this.pDialog2 = this.loadFragment({
                        name: "sap.hum.pfe.view.nav.ChangeCancel"
                    });
                }
